...
export class _OLD_ContentArticleDataParagraph extends ContentArticleDataAbstract
{
	...
	static init(currentUrl: string, $: any, tag: any): _OLD_ContentArticleDataParagraph
	{
		let textComponents = []
