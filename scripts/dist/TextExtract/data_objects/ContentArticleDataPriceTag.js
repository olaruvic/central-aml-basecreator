...
class ContentArticleDataPriceTag extends ContentArticleDataAbstract_1.ContentArticleDataAbstract {
    ...
    static init(currentUrl, $, tag) {
        ...
        const o = $(tag);
        return new ContentArticleDataPriceTag(o.text(), o.prop('class'), textComponents);
    }
}
exports.ContentArticleDataPriceTag = ContentArticleDataPriceTag;
