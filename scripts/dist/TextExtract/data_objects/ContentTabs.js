...
class ContentTabs extends ContentAbstract_1.ContentAbstract {
    constructor() {
        super(ContentAbstract_1.ContentType.tabs);
        this.title = null;
    }
    static init(url, $, tag) {
        let result = new ContentTabs();
    ...
    _parse(url, $, tag) {
        ...
        console.dir(tab_headers, { colors: true });
